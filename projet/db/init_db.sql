...
CREATE TABLE "reservations_client_choix" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "reservation" integer NOT NULL,
  "resource" varchar NOT NULL,
  "id_choix_ressource" integer NOT NULL
);
...
ALTER TABLE "reservations_client_choix" ADD FOREIGN KEY ("reservation") REFERENCES "reservation" ("id");

ALTER TABLE "reservations_client_choix" ADD FOREIGN KEY ("id_choix_ressource") REFERENCES "options_resource_choix" ("id");

ALTER TABLE "reservations_client_choix" ADD FOREIGN KEY ("resource") REFERENCES "ressource" ("label");
